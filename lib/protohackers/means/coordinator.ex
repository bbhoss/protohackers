defmodule Protohackers.Means.Coordinator do
  alias Protohackers.Means.{Coordinator, Acceptor}
  use GenServer
  alias __MODULE__
  ...
  @impl true
  def init(_arg) do
    {:ok, sock} = :gen_tcp.listen(9997, [:inet6, :binary, active: true, packet: :raw, reuseaddr: true])
    IO.puts("Listening on 9997")
