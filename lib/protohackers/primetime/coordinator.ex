defmodule Protohackers.Primetime.Coordinator do
  alias Protohackers.Primetime.{Coordinator, Acceptor}
  use GenServer
  alias __MODULE__
  ...
  @impl true
  def init(_arg) do
    {:ok, sock} = :gen_tcp.listen(9998, [:inet6, :binary, active: true, packet: :line, reuseaddr: true])
    IO.puts("Listening on 9998")
